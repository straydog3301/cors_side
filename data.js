...
const GameData = (function() {
  ...
  },
  {
    ...
    "type": "2",
    "headline": "幻光科技股價大跌",
    "content": "總部位於上城的幻光科技有限公司今日股價驟降 23%，引發市場恐慌。",
    "priority": "7",
    "minDay": "1"
  },
  {
    "_file": "Quest_Result.asset",
    "_type": "CyberOccult.Data.NewsItemData",
    "id": "quest_result_01",
    "type": "1",
    "headline": "委託完成報告",
  ...
  "characters": [
    {
      ...
      "description": "白袍金絲眼鏡，手持精密掃描儀器的審判官。來自光環科技下屬的異端審裁處，專門處理「數據層面的神異事件」。冷靜、克制、每一句話都是陷阱——但他在靈樞堂前停留的時間，似乎比必要的更長。",
      "tags": [
        "審判官",
        "教會線",
        "冷靜"
    ...
    },
    {
      ...
      "route": "LYCAON_ROUTE",
      "role": "改造逃亡者 · 渴望真相的野獸",
      "description": "銀髮異色瞳，左臂為改造機械義肢。曾在企業實驗室中度過不為人知的歲月，逃出後成為地下區最危險也最值得信任的夥伴。脾氣火爆，忠誠度卻是MAX——只要他認定了你。",
      "tags": [
        "改造人",
        "地下線",
        "火爆"
